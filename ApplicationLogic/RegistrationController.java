...
public class RegistrationController {
  ...
  public void create(Registration registration) throws SQLException {
    if (true) {
      ...
      InfoBox.Display("registration not added", "A registration with this email already exists");
    }
  }
  ...
  // been updated to: " + newEmail);
  // } else {
  // InfoBox.Display("Student not updated", "A student with this email does not
  // exist");
  // }
  // }
  ...
  // if (result) {
  // InfoBox.Display("Deleted student", "Student (" + email + ") has been
  // successfully deleted");
  // } else {
  // InfoBox.Display("Student not deleted",
  // "Student (" + email + ") was not deleted, \n" + "there was no student found
  // with this email");
  // }
  // }
